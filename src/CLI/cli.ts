...
program
  ...
  .option('-ef, --exportFrom <address>', 'First address of the memory to be included in the dump. If unspecified, it defaults to address 0.')
  .option('-et, --exportTo <address>', 'Last memory address to be included in the dump. If unspecified, it defaults to 0xFFFFFF.')
